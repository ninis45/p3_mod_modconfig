...
Partial Class grfProductividad
    ...
    Private Sub InitializeComponent()
        ...
        '
        '
        Me.TChart1.Axes.Bottom.Title.Caption = "QLíquido (bpd)"
        '
        '
        '
        '
        ...
        Me.TChart1.Axes.Bottom.Title.Lines = New String() {"QLíquido (bpd)"}
        '
        '
        '
        '
        ...
        '
        '
        Me.TChart1.Axes.Left.Title.Caption = "Presión (kg/cm2)"
        '
        '
        '
        '
        ...
        Me.TChart1.Axes.Left.Title.Lines = New String() {"Presión (kg/cm2)"}
        '
        '
        '
        '
